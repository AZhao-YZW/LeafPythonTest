...
{
    testing::internal::CaptureStdout();
    core_log("test: format string[%s]", "this is format string");
    std::string output = testing::internal::GetCapturedStdout();
...
{
    testing::internal::CaptureStdout();
    core_log("test: format number[%u, %u, %u, %u, %u, %u, %u]",
...
{
    testing::internal::CaptureStdout();
    core_log("test: format number[%lu, %lu, %lu, %lu, %lu, %lu, %lu]",
        0, 1, 255, 256, 65535, 65536, 4294967295);
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "[core] test: format number"
        "[0, 1, 255, 256, 65535, 65536, 4294967295]");
...
{
    testing::internal::CaptureStdout();
    core_log("test: format number[%llu, %llu, %llu, %llu, %llu, %llu, %llu, %llu, %llu]",
...
{
    testing::internal::CaptureStdout();
    core_log("test: format number[%d, %d, %d, %d, %d, %d, %d, %d, %d]",
...
{
    testing::internal::CaptureStdout();
    core_log("test: format number[%ld, %ld, %ld, %ld, %ld, %ld, %ld, %ld, %ld]",
        0, 1, -1, 127, -128, 32767, -32768, 2147483647, -2147483648);
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "[core] test: format number"
        "[0, 1, -1, 127, -128, 32767, -32768, 2147483647, -2147483648]");
...
{
    testing::internal::CaptureStdout();
    core_log("test: format number[%lld, %lld, %lld, %lld, %lld, %lld, %lld, %lld, %lld, %lld]",
...
{
    testing::internal::CaptureStdout();
    corename_log(LEAFPY_CORE_NAME_LEAFPY, "test: core name test");
    std::string output = testing::internal::GetCapturedStdout();
    EXPECT_EQ(output, "[leafpy] test: core name test");

    testing::internal::CaptureStdout();
    corename_log(LEAFPY_CORE_NAME_TESTCORE, "test: core name test");
